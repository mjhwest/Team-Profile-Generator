...
// const people = []
// const people = [{ role: "Manager", name: "Michael", id: 1, emai: "" }, { name: "Sally", role: "Intern" }, { name: "Tom", role: "Engineer" }];
...
const renderPage = (people) => {
    ...
    for (const person of people) {
        switch (person.getRole()) {
            case 'Manager':
                cardHTML += `<div class="container card-container">
                <div class="card employee-card mx-2 my-2" style="width: 20rem;">
                <div class="card-header">
                    <h5 class="card-title">Manager Name: ${person.name}</h5>
            ...
            case 'Engineer':
                ...
                <div class="card-header">
                    <h5 class="card-title">Engineer Name: ${person.name}</h5>
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">ID: ${person.id}</li>
                        <li class="list-group-item">Email: ${person.email}</li>
                        <li class="list-group-item">Git Hub Username: ${person.gitHub}</li>
                    </ul>
                </div>
            </div>`
                break;
            case 'Intern':
                cardHTML += `  <div class="card employee-card mx-2 my-2" style="width: 20rem;">
                <div class="card-header">
                    <h5 class="card-title">Intern Name ${person.name}</h5>
